...
impl From<Event> for WordleEvent {
    fn from(event: Event) -> Self {
        match event {
            ...
            Event::WordChecked { player, correct_positions, contained_letters } => 
                WordleEvent::WordChecked { player, correct_positions, contained_letters },
